 ...
 */
public class GankViewModel extends BindingViewModel<TestFragBinding> {
    ...
    GankViewModel(Context context, Fragment fragment, TestFragBinding binding) {
        super(binding);
    ...
    private void init() {
        ...
        RxBus.get().toObservable(PopImageEvent.class)
