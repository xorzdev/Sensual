 ...
 */
public class TestAdapter extends RecyclerHeaderFooterAdapter<Welfare, TestItemTwoBinding, RighterLoadingBinding, RighterLoadingBinding> {

    private Fragment fragment;

    public TestAdapter(Context context, Fragment fragment, List<Welfare> mList) {
        super(context, mList, R.layout.test_item_two);
        this.fragment = fragment;
    }

    @Override
    public void onBind(RecyclerHolder<TestItemTwoBinding> holder, int position, Welfare t) {
