...
public class ZhihuQuestionFragment extends BindingFragment<LayoutToolbarRecyclerBinding> {
    ...
    private void init() {
        ...
        id = getArguments().getLong(BundleKey.PAGE_TYPE);

        binding.includeToolbar.toolbar.setTitle("知乎看图 - 问题");
    ...
    private void getImage(boolean isMore) {
        mViewModel.getImage(getDataLayer().getZhihuPicService().getQuestionPic(this, id, 5, isMore ? binding.recycler.offset * 5 : 0), isMore);
    }
}
