 ...
 */
public class BigImageViewModel extends BindingViewModel<LayoutToobleRecyclerBinding> {
    ...
    public BigImageViewModel(Context context, Fragment fragment, LayoutToobleRecyclerBinding binding) {
        super(binding);
