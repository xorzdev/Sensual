...
public class HtmlUtil {
     ...
     * @return String
     */
    public static String createHtmlData(News news) {
        final String css = HtmlUtil.createCssTag(news.getCssList());
        final String js = HtmlUtil.createJsTag(news.getJsList());
