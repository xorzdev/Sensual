 ...
 */
public class MzituAdapter extends RecyclerHeaderFooterAdapter<Image, ItemDoubanBinding, ViewDataBinding, FooterLoadingBinding> {

    private OnItemClickListener mListener;

    private int mWidth;

    public MzituAdapter(Context context, List<Image> mData) {
    ...
    public void onBind(RecyclerHolder<ItemDoubanBinding> holder, int position, Image t) {
        ...
        ImageLoader.loadMzitu(holder.binding.imageView, t.getUrl(), mWidth, tempHeight);
